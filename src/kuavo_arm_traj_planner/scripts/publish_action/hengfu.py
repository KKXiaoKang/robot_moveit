...
if __name__ == "__main__":
    ...
    l_traj = load_traj("config/traj_l_hengfu1.json")
    r_traj = load_traj("config/traj_r_hengfu1.json")
    publish_lr_arm_traj(publisher, l_traj, r_traj)
    input("===================展开:")
    l_traj = load_traj("config/traj_l_hengfu2.json")
    r_traj = load_traj("config/traj_r_hengfu2.json")
    publish_lr_arm_traj(publisher, l_traj, r_traj)
